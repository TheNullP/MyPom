...
def test_endpoint_pesquisa_usuarios(user, db, client):
    ...
    assert len(response.json()) == 1, (
        "Pesquisa de lista de usuário incorreto, deveria haver somente 1 resgistro."
    )
